# Second Run Feedback Questions

Use these questions immediately after the second supervised live-provider run.
Keep answers short unless a participant wants to explain a blocker.
...
1. Did the AI reduce your workload during the run?
...
- Record exact UI labels or moments when participants mention confusion.
- Separate bugs from preference feedback.
- Do not record provider secrets, private payloads, or player contact details.
